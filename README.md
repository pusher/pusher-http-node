...
var pusher = new Pusher({
  ...
  encryptionMasterKey: ENCRYPTION_MASTER_KEY, // optional, a 32 character long key used to derive secrets for end to end encryption (see below!)
});
```
...
See https://pusher.com/beams, our new Push Notifications product!
