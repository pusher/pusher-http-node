...
describe("Pusher", function() {
  ...
  describe("#auth", function() {
    it("should prefix the signature with the app key", function() {
      ...
      expect(pusher.auth("123.456", "test")).to.eql({
    ...
    it("should return correct authentication signatures for different socket ids", function() {
      ...
      expect(pusher.auth("321.654", "test")).to.eql({
    ...
    it("should return correct authentication signatures for different channels", function() {
      expect(pusher.auth("123.456", "test1")).to.eql({
        auth: "aaaa:2e8533af473c22fbf5456375ace186413bcdd64513edefc60657d7327c1a43af"
      });
      expect(pusher.auth("123.456", "test2")).to.eql({
    ...
    it("should return attach user info", function() {
      expect(pusher.auth("123.456", "test", { foo: "bar" }).channel_data).to.eql(
        "{\"foo\":\"bar\"}"
      );
    });
    ...
    it("should return correct authentication signatures with and without user info", function() {
      ...
      expect(pusher.auth("123.456", "test", { foo: "bar" })).to.eql({
